...
import XiaolaiMonoSC from "./assets/XiaolaiMonoSC-Regular.woff2";
import XiaolaiSC from "./assets/XiaolaiSC-Regular.woff2";
...
export class Fonts {
  ...
  private static init() {
    ...
    _register(
      "XiaolaiMonoSC",
      FONT_METADATA[FONT_FAMILY.XiaolaiMonoSC],
      { uri: XiaolaiMonoSC },
      { uri: XiaolaiSC },
    );
