...
import { FaCodeIcon, FaRegEditIcon, copyIcon, fullscreenIcon } from "./icons";
...
class App extends React.Component<AppProps, AppState> {
                    ...
                    >
                      ...
                      >
                        <LayerUI
                          ...
                          onEditFirstSelectedElement={(data: string) => {
                            const frameElement = JSON.parse(
                              JSON.stringify(firstSelectedElement),
                            );
                            this.setState({
                              selectedElementIds: {
                            ...
                            if (
                              ...
                              this.onUpdateMagicFrameGenerate(frameElement, {
                                status: "done",
                                html: data,
                              });
                            }
                        ...
                        {selectedElements.length === 1 &&
                          ...
                          firstSelectedElement.customData?.generationData
                            ...
                            >
                              ...
                              />
                              <ElementCanvasButton
                                title={t("labels.editCode")}
                                icon={FaRegEditIcon}
                                checked={false}
                                onChange={() => {
                                  this.actionManager.executeAction(editCode);
                                }}
                              />
                              <ElementCanvasButton
  ...
  private updateMagicGeneration = ({
    ...
    frameElement: ExcalidrawIframeElement | ExcalidrawElement;
  ...
  private async onUpdateMagicFrameGenerate(
  ...
  private onKeyDown = withBatchedUpdates(
    (event: React.KeyboardEvent | KeyboardEvent) => {
      ...
      if (isArrowKey(event.key)) {
        ...
        const shape = findShapeByKey(event.key) as unknown as string;
if (shape === "chat") {
